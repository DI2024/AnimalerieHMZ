            ...
            <div class="grid grid-cols-1 md:grid-rows-[92px_1fr] gap-4">
                ...
                <div class="hidden md:block relative overflow-hidden rounded-2xl">
                    <div class="flex items-center">
                        <img src="<?php echo e(asset('images/img brand.png')); ?>" alt="Marques de produits" class="w-full h-full object-cover">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-[65%_35%] gap-4">
                    ...
                    <div class="hero-slides-container">
                        <div class="hero-slides-scroll">
                            <?php $__empty_1 = true; $__currentLoopData = $heroSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="hero-slide relative rounded-2xl h-[460px] overflow-hidden <?php echo e($index > 0 ? 'hidden md:block' : ''); ?>">
                                    <!-- Image de fond -->
                                    <?php
                                        $slideImageUrl = filter_var($slide->image, FILTER_VALIDATE_URL) 
                                            ...
                                            : asset($slide->image);
                                    ?>
                                    <img src="<?php echo e($slideImageUrl); ?>" alt="<?php echo e($slide->title); ?>" class="w-full h-full object-cover">
                                    
                                    <!-- Bouton positionné en bas à droite -->
                                    <?php if($slide->button_text): ?>
                                        <div class="absolute bottom-6 right-6">
                                            <a href="<?php echo e($slide->button_link ?: route('products.index')); ?>" class="bg-[#003e87] hover:bg-[#0855b1] text-white font-bold py-3 px-6 md:py-4 md:px-8 rounded-full transition shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 text-sm flex items-center justify-center gap-2 w-fit">
            ...
            <div class="offers-mobile-scroll grid grid-cols-1 md:grid-cols-3 gap-8">
                <?php $__empty_1 = true; $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <?php if($offer->type === 'pack'): ?>
                        ...
                        <a href="<?php echo e($offerLink); ?>" 
                           class="relative flex items-center justify-between p-8 rounded-3xl overflow-hidden min-h-[200px] border-2 border-purple-500/20 group transition-all duration-500 md:hover:scale-105 md:hover:shadow-2xl md:hover:border-purple-600 cursor-pointer <?php echo e($offer->bg_color ? 'text-white' : 'bg-white text-purple-700'); ?>"
                           style="<?php echo e($offer->bg_color ? 'background-color: ' . $offer->bg_color . ';' : ''); ?>">
                            <div class="flex-1 pr-4 z-10">
                                <h3 class="font-headline text-lg font-bold leading-tight mb-2 <?php echo e($offer->bg_color ? 'text-white' : 'text-purple-950'); ?>"><?php echo e($offer->title); ?></h3>

                                <div class="mt-2 md:mt-4 flex flex-col items-start gap-1">
                                    <span class="text-base md:text-2xl font-bold <?php echo e($offer->bg_color ? 'text-white' : 'text-purple-600'); ?>"><?php echo e(number_format($offer->pack_price, 2, ',', ' ')); ?> MAD</span>
                                    <?php if($offer->total_original_price > 0 && $offer->total_original_price > $offer->pack_price): ?>
                                        <span class="text-xs md:text-sm line-through <?php echo e($offer->bg_color ? 'text-white/70' : 'text-gray-400'); ?>"><?php echo e(number_format($offer->total_original_price, 2, ',', ' ')); ?> MAD</span>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <?php elseif($offer->type === 'percentage'): ?>
                        ...
                        <a href="<?php echo e($offerLink); ?>" 
                           class="relative flex items-center justify-between p-8 rounded-3xl overflow-hidden min-h-[200px] text-white group transition-all duration-500 md:hover:scale-105 md:hover:shadow-2xl cursor-pointer <?php echo e($offer->bg_color ? '' : 'bg-gradient-to-br from-tertiary to-blue-600'); ?>"
                           style="<?php echo e($offer->bg_color ? 'background-color: ' . $offer->bg_color . ';' : ''); ?>">
                            <div class="flex-1 pr-4 z-10">
                                <?php if($offer->badge): ?>
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e($offerLink); ?>" 
                           class="relative flex items-center justify-between p-8 rounded-3xl overflow-hidden min-h-[200px] text-white group transition-all duration-500 md:hover:scale-105 md:hover:shadow-2xl cursor-pointer <?php echo e($offer->bg_color ? '' : 'bg-gradient-to-br from-primary-container to-primary'); ?>"
                           style="<?php echo e($offer->bg_color ? 'background-color: ' . $offer->bg_color . ';' : ''); ?>">
                            <div class="flex-1 pr-4 z-10">
                                <?php if($offer->badge): ?>
                                    <span class="hidden md:inline-block bg-white/30 backdrop-blur-sm px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider mb-4 shadow-lg">
        ...
        <div class="max-w-[1280px] mx-auto px-6">
            ...
            <div class="subcategories-mobile-scroll grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
                <a href="<?php echo e(route('products.index', ['subcategory' => 'cage-transport'])); ?>" class="bg-gradient-to-br from-purple-100 to-purple-200 hover:from-purple-200 hover:to-purple-300 transition-all duration-300 p-8 rounded-2xl flex justify-between items-center group shadow-md hover:shadow-xl">
                    ...
                    <img src="<?php echo e(asset('images/products/img_product_chat/jlsb.jpg')); ?>" alt="Cage" class="w-20 h-20 object-cover rounded-full group-hover:scale-110 transition-transform duration-300 shadow-lg">
                </a>
                <a href="<?php echo e(route('products.index', ['subcategory' => 'croquettes-chat'])); ?>" class="bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300 transition-all duration-300 p-8 rounded-2xl flex justify-between items-center group shadow-md hover:shadow-xl">
                    ...
                    <img src="<?php echo e(asset('images/products/img_product_chat/rc_vet_dry_caturinarysomc_mv_eretailkit_de_de_7.jpg')); ?>" alt="Croquettes" class="w-20 h-20 object-cover rounded-full group-hover:scale-110 transition-transform duration-300 shadow-lg">
                </a>
                <a href="<?php echo e(route('products.index', ['subcategory' => 'accessoires-chat'])); ?>" class="bg-gradient-to-br from-green-100 to-green-200 hover:from-green-200 hover:to-green-300 transition-all duration-300 p-8 rounded-2xl flex justify-between items-center group shadow-md hover:shadow-xl">
                    <span class="font-bold text-gray-900 text-lg">Accessoires</span>
                    <img src="<?php echo e(asset('images/products/img_product_chat/527097_pla_tiaki_scratching_stairs_puzzle_fg_6858_3.jpg')); ?>" alt="Arbre à chat" class="w-20 h-20 object-cover rounded-full group-hover:scale-110 transition-transform duration-300 shadow-lg">
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-[1280px] mx-auto px-6">
            ...
            <div class="subcategories-mobile-scroll grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
                ...
                <a href="<?php echo e(route('products.index', ['subcategory' => 'graines-nutrition'])); ?>" class="bg-gradient-to-br from-green-100 to-green-200 hover:from-green-200 hover:to-green-300 transition-all duration-300 p-8 rounded-2xl flex justify-between items-center group shadow-md hover:shadow-xl">
                    <span class="font-bold text-gray-900 text-lg">Graines & Nutrition</span>
                    <img src="<?php echo e(asset('images/products/img_product_oiseau/Melange-pour-calopsitte-e1714228585714-510x510-1.webp')); ?>" alt="Graines" class="w-20 h-20 object-cover rounded-full group-hover:scale-110 transition-transform duration-300 shadow-lg">
                </a>
                <a href="<?php echo e(route('products.index', ['subcategory' => 'accessoires-oiseaux'])); ?>" class="bg-gradient-to-br from-purple-100 to-purple-200 hover:from-purple-200 hover:to-purple-300 transition-all duration-300 p-8 rounded-2xl flex justify-between items-center group shadow-md hover:shadow-xl">
                    <span class="font-bold text-gray-900 text-lg">Accessoires</span>
                    <img src="<?php echo e(asset('images/products/img_product_oiseau/61i5pYks9dL._AC_UF1000,1000_QL80_.jpg')); ?>" alt="Jouets" class="w-20 h-20 object-cover rounded-full group-hover:scale-110 transition-transform duration-300 shadow-lg">
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 md:py-16 bg-surface-container-low">
        <div class="max-w-[1280px] mx-auto px-6">
            ...
            <div class="grid grid-cols-2 gap-4 md:hidden">
                ...
                <!-- Ligne 1: Pigeon -->
                <div class="relative overflow-hidden rounded-xl aspect-square group">
                    <img src="<?php echo e(asset('images/téléchargement.jpg')); ?>" alt="Pigeon" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                </div>
            ...
            <div class="hidden md:grid grid-cols-3 gap-3">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="relative overflow-hidden rounded-xl h-[180px] group">
                        <img src="<?php echo e(asset('images/gal peg1.png')); ?>" alt="Pigeon" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\animx\AnimalerieHMZ\resources\views/welcome.blade.php ENDPATH**/ ?>