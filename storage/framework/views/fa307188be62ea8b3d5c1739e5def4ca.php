...
<?php $__env->startSection('title', $isPack ? 'Modifier Pack' : 'Modifier Offre'); ?>
<?php $__env->startSection('page-title', $isPack ? 'Modifier le Pack' : 'Modifier l\'Offre'); ?>
...
<div class="bg-white rounded-lg shadow p-8">
    <form action="<?php echo e(route('admin.offers.update', $offer)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        
        <!-- Hidden input for type -->
        <input type="hidden" name="type" value="<?php echo e($offer->type); ?>">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="title" 
                           id="title" 
                           value="<?php echo e(old('title', $offer->title)); ?>"
                           required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           name="subtitle" 
                           id="subtitle" 
                           value="<?php echo e(old('subtitle', $offer->subtitle)); ?>"
                           class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2" 
                           style="border-color: #e5e7eb;"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           name="badge" 
                           id="badge" 
                           value="<?php echo e(old('badge', $offer->badge)); ?>"
                           class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2" 
                           style="border-color: #e5e7eb;"
                           onfocus="this.style.borderColor='#003e87'; this.style.boxShadow='0 0 0 3px rgba(0,62,135,0.1)'"
                           onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none'"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           name="link" 
                           id="link" 
                           value="<?php echo e(old('link', $offer->link)); ?>"
                           class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2" 
                           style="border-color: #e5e7eb;"
                           onfocus="this.style.borderColor='#003e87'; this.style.boxShadow='0 0 0 3px rgba(0,62,135,0.1)'"
                           onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none'"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" 
                           name="pack_price" 
                           id="pack_price" 
                           value="<?php echo e(old('pack_price', $offer->pack_price)); ?>"
                           required
                           min="0"
                           step="0.01"
                           class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div id="hidden_inputs_container">
                        ...
                        ?>
                        <?php $__currentLoopData = $selectedProductIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="border rounded-lg p-4 mb-4">
                        <img src="<?php echo e(filter_var($offer->image, FILTER_VALIDATE_URL) ? $offer->image : asset('storage/' . $offer->image)); ?>" 
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                        <?php echo e($offer->image ? 'Changer l\'image' : 'Image'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" 
                           name="order" 
                           id="order" 
                           value="<?php echo e(old('order', $offer->order ?? 0)); ?>"
                           required
                           min="0"
                           class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2" 
                           style="border-color: #e5e7eb;"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label class="flex items-center cursor-pointer">
                        ...
                        <input type="checkbox" 
                               name="is_active" 
                               value="1" 
                               <?php echo e(old('is_active', $offer->is_active) ? 'checked' : ''); ?>
        ...
        <div class="mt-8 flex items-center gap-4">
            <button type="submit" 
                ...
                <i class="fas fa-save mr-2"></i><?php echo e($isPack ? 'Enregistrer le pack' : 'Mettre à jour'); ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const oldProductIds = <?php echo json_encode(old('product_ids', $offer->products->pluck('id')->toArray()), 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\animx\AnimalerieHMZ\resources\views/admin/offers/edit.blade.php ENDPATH**/ ?>