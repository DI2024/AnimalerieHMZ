    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-600 mt-1"><?php echo e($stats['inactive']); ?></p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-primary mt-1"><?php echo e($stats['total_products']); ?></p>
            </div>
...
<div class="flex gap-6 relative">
    ...
    <div class="bg-white rounded-lg shadow p-4">
        ...
        <div class="flex flex-col md:flex-row md:items-center gap-3 mb-3">
            ...
            <div class="relative flex-1 min-w-[200px] max-w-[600px]">
                <form method="GET" action="<?php echo e(route('admin.categories.index')); ?>" id="search-form">
                    ...
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('admin.categories.index')); ?>" class="absolute right-3 top-3.5 text-gray-400 hover:text-gray-600">
        ...
        <div class="flex flex-row items-center justify-between gap-3 mt-2 border-t pt-3 md:border-t-0 md:pt-0 md:mt-0">
            ...
            <div class="text-sm text-gray-600 font-bold md:order-2">
                <span id="category-count"><?php echo e($categories->count()); ?></span> catégorie(s)
            </div>
    ...
    <div id="table-view" class="bg-white rounded-lg shadow">
        ...
        <table class="w-full" id="categories-table">
            ...
            <tbody class="divide-y divide-gray-200" id="sortable-categories">
                ...
                <tr class="category-row hover:bg-gray-50 cursor-pointer" data-id="<?php echo e($category->id); ?>">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500"><?php echo e($category->slug); ?></p>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 text-sm">
                        <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-medium">
                            <span class="md:hidden"><?php echo e($category->products_count); ?></span>
                            <span class="hidden md:inline"><?php echo e($category->products_count); ?> produit<?php echo e($category->products_count > 1 ? 's' : ''); ?></span>
                        </span>
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-600 hidden md:table-cell">
                        <span class="order-value"><?php echo e($category->order); ?></span>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-sm hidden md:table-cell">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-item" onclick="quickView(<?php echo e($category->id); ?>)">
                                ...
                                <a href="<?php echo e(route('admin.products.index')); ?>?categories[]=<?php echo e($category->id); ?>" 
                                   class="dropdown-item">
                                    <i class="fas fa-box"></i>
                                    Voir les produits
                                </a>
                                <div class="dropdown-divider"></div>
                                <div class="dropdown-item text-red-600" onclick="deleteCategory(<?php echo e($category->id); ?>)">
    ...
    <div id="grid-view" class="hidden space-y-6">
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-4" data-id="<?php echo e($category->id); ?>">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-gray-500 mb-2"><?php echo e($category->slug); ?></p>
                        ...
                        <div class="flex items-center gap-4 text-sm text-gray-600">
                            ...
                            <span>
                                ...
                                Ordre: <span class="order-value"><?php echo e($category->order + 1); ?></span>
                            </span>
                        </div>
                    </div>
            ...
            <div class="col-span-full">
                <?php if(request('search')): ?>
                    ...
                    <div class="flex flex-col items-center justify-center text-gray-500 py-12">
                        ...
                        <p class="text-sm text-gray-500 mb-4">Aucune catégorie ne correspond à "<?php echo e(request('search')); ?>"</p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\animx\AnimalerieHMZ\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>