                ...
                <div class="space-y-1 max-h-64 overflow-y-auto">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
                            ...
                            <span class="text-sm text-gray-700 flex-1"><?php echo e($category->name); ?></span>
                            <span class="text-xs text-gray-400">(<?php echo e($category->products_count ?? 0); ?>)</span>
                        </label>
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div>
                            ...
                            <input type="number" name="price_min" value="<?php echo e(request('price_min', 0)); ?>" 
                                   min="0" step="10"
                        ...
                        <div>
                            ...
                            <input type="number" name="price_max" value="<?php echo e(request('price_max', 5000)); ?>" 
                                   min="0" step="10"
                                   class="w-full px-3 py-1.5 border rounded text-sm focus:ring-2 focus:ring-primary">
                        </div>
                    </div>
                ...
                <div class="space-y-1">
                    <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
                        <input type="checkbox" name="stock[]" value="in_stock"
                               <?php echo e(in_array('in_stock', request('stock', [])) ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
                        <input type="checkbox" name="stock[]" value="low_stock"
                               <?php echo e(in_array('low_stock', request('stock', [])) ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
                        <input type="checkbox" name="stock[]" value="out_of_stock"
                               <?php echo e(in_array('out_of_stock', request('stock', [])) ? 'checked' : ''); ?>
                ...
                <div class="space-y-1">
                    <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
                        <input type="checkbox" name="badges[]" value="new"
                               <?php echo e(in_array('new', request('badges', [])) ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
                        <input type="checkbox" name="badges[]" value="bestseller"
                               <?php echo e(in_array('bestseller', request('badges', [])) ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
                        <input type="checkbox" name="badges[]" value="featured"
                               <?php echo e(in_array('featured', request('badges', [])) ? 'checked' : ''); ?>
                ...
                <div class="space-y-1">
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
                        <input type="radio" name="status" value="active"
                               <?php echo e(request('status') == 'active' ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
                        <input type="radio" name="status" value="inactive"
                               <?php echo e(request('status') == 'inactive' ? 'checked' : ''); ?>
...
<?php /**PATH C:\Users\User\Desktop\animx\AnimalerieHMZ\resources\views/admin/products/partials/filter-sidebar.blade.php ENDPATH**/ ?>