    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex flex-wrap gap-4 items-center">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('admin.orders.index', ['date_from' => date('Y-m-d', strtotime('-7 days')), 'date_to' => date('Y-m-d')])); ?>" 
                   class="px-4 py-2 text-sm bg-gray-100 hover:bg-[#003e87] hover:text-white rounded-lg transition-colors">
                    <i class="fas fa-calendar-week mr-1"></i>
                    Cette semaine
                </a>
                <a href="<?php echo e(route('admin.orders.index', ['status_filter' => ['pending']])); ?>" 
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 cursor-pointer" onclick="window.location='<?php echo e(route('admin.orders.show', $order->id)); ?>'">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-2">
                            <i class="fas fa-hashtag text-gray-400 text-xs"></i>
                            <span class="text-[#003e87] font-semibold"><?php echo e($order->order_number); ?></span>
                        </div>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <p class="text-lg font-bold text-gray-900"><?php echo e(number_format($order->total, 2)); ?> DH</p>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php
                            $statusClasses = [
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\temp-laravel\AnimalerieHMZ\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>