                ...
                <div class="bg-gradient-to-br from-primary/5 to-primary/10 rounded-3xl p-8 shadow-xl border border-primary/20 relative overflow-hidden">
                    ...
                    <div class="space-y-6 relative z-10">
                        <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div class="cart-item flex gap-4 items-center border-b border-gray-200 pb-4 transition-transform duration-200" data-product-id="<?php echo e($item['product']->id); ?>">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-center gap-3 mt-2">
                                        ...
                                        <div class="flex items-center bg-surface-container-low rounded-full border border-gray-200">
                                            <button onclick="updateCartQuantity(<?php echo e($item['product']->id); ?>, <?php echo e($item['quantity'] - 1); ?>)" 
                                            ...
                                            <span class="item-quantity w-8 text-center text-sm font-bold text-on-surface"><?php echo e($item['quantity']); ?></span>
                                            <button onclick="updateCartQuantity(<?php echo e($item['product']->id); ?>, <?php echo e($item['quantity'] + 1); ?>)" 
                                                    class="w-7 h-7 flex items-center justify-center text-sm font-bold hover:bg-gray-100 rounded-full transition text-on-surface">+</button>
                                        </div>
                                        <!-- Remove Button -->
                                        <button onclick="removeFromCart(<?php echo e($item['product']->id); ?>)" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\animx\AnimalerieHMZ\resources\views/checkout.blade.php ENDPATH**/ ?>