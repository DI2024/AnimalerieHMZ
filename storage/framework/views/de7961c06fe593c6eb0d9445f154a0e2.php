                ...
                <div class="bg-gradient-to-br from-primary/5 to-primary/10 rounded-3xl p-8 shadow-xl border border-primary/20 relative overflow-hidden">
                    ...
                    <div class="mt-12 space-y-3 pt-6 border-t border-gray-200 relative z-10">
                        ...
                        <div class="flex justify-between text-white/80">
                            ...
                            <?php else: ?>
                                <span><?php echo e(number_format($shippingCost, 2, ',', ' ')); ?> MAD</span>
                            <?php endif; ?>
                        </div>
                        <div class="flex justify-between text-white/80">
                            <span>TVA (20%)</span>
                            <span><?php echo e(number_format($tax, 2, ',', ' ')); ?> MAD</span>
                        </div>
                        <div class="flex justify-between items-end pt-4">
                            <span class="text-xl font-headline font-bold">Total TTC</span>
                            <span class="text-3xl font-headline font-extrabold tracking-tight"><?php echo e(number_format($total, 2, ',', ' ')); ?> MAD</span>
                        </div>
                    </div>
