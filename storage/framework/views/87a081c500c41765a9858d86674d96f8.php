        ...
        <div class="max-w-[1280px] mx-auto px-6">
            ...
            <div class="md:hidden flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-1">
                    <!-- Cart Icon -->
                    <a href="<?php echo e(route('cart.show')); ?>" class="relative w-12 h-12 flex items-center justify-center hover:bg-surface-container-low rounded-lg transition-colors">
                        <span class="material-symbols-outlined text-on-surface">shopping_cart</span>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <!-- Profile Icon -->
                        <a href="<?php echo e(route('dashboard')); ?>" class="w-12 h-12 flex items-center justify-center hover:bg-surface-container-low rounded-lg transition-colors">
                            <span class="material-symbols-outlined text-primary">account_circle</span>
                        </a>
                    <?php else: ?>
                        <!-- Login Icon -->
                        <a href="<?php echo e(route('login')); ?>" class="w-12 h-12 flex items-center justify-center hover:bg-surface-container-low rounded-lg transition-colors">
                ...
                <div class="col-span-2 md:col-span-1 text-center md:text-left">
                    ...
                    <div class="flex gap-3 mt-6 justify-center md:justify-start">
                        <?php if(!empty($siteSettings['social_facebook'])): ?>
                            <a href="<?php echo e($siteSettings['social_facebook']); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors" aria-label="Facebook">
                                <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            </a>
                        <?php endif; ?>
                        <?php if(!empty($siteSettings['social_instagram'])): ?>
                            <a href="<?php echo e($siteSettings['social_instagram']); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors" aria-label="Instagram">
                        ...
                        <?php if(!empty($siteSettings['social_whatsapp'])): ?>
                            <a href="<?php echo e($siteSettings['social_whatsapp']); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors" aria-label="WhatsApp">
