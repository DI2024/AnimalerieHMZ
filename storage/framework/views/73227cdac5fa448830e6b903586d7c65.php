<div class="filter-sidebar bg-white rounded-lg shadow-sm p-6">
    ...
    <form id="filterForm" method="GET" action="<?php echo e(route('admin.orders.index')); ?>">
                ...
                <div class="space-y-2 mt-3">
                    <label class="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                        <input type="checkbox" name="status_filter[]" value="pending" 
                               <?php echo e(in_array('pending', request('status_filter', [])) ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                        <input type="checkbox" name="status_filter[]" value="confirmed"
                               <?php echo e(in_array('confirmed', request('status_filter', [])) ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                        <input type="checkbox" name="status_filter[]" value="delivered"
                               <?php echo e(in_array('delivered', request('status_filter', [])) ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                        <input type="checkbox" name="status_filter[]" value="cancelled"
                               <?php echo e(in_array('cancelled', request('status_filter', [])) ? 'checked' : ''); ?>
            ...
            <div class="filter-section-content collapsed" id="section-date">
                <div class="space-y-3 mt-3">
                    ...
                    <div class="pt-3 border-t">
                        ...
                        <input type="date" name="date_from" id="dateFrom" value="<?php echo e(request('date_from')); ?>"
                    ...
                    <div>
                        ...
                        <input type="date" name="date_to" id="dateTo" value="<?php echo e(request('date_to')); ?>"
                               class="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#003e87]">
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\temp-laravel\AnimalerieHMZ\resources\views/admin/orders/partials/filter-sidebar.blade.php ENDPATH**/ ?>