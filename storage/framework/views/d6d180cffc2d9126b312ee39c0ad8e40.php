        ...
        <div class="max-w-[1280px] mx-auto px-6">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center gap-4">
                    <!-- Cart Icon -->
                    <a href="<?php echo e(route('api.cart.index')); ?>" class="relative p-2 hover:bg-surface-container-low rounded-lg transition-colors">
    ...
    <footer id="contact" class="bg-primary text-on-primary py-16">
        <div class="max-w-[1280px] mx-auto px-6">
            ...
            <div class="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-primary-light text-sm">© <?php echo e(date('Y')); ?> Animalerie HMZ. Tous droits réservés.</p>
