        ...
        <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden border border-gray-200">
            <div class="p-6">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <a href="<?php echo e(route('admin.sections.hero.index')); ?>" class="inline-flex items-center px-4 py-2 bg-[#003e87] text-white rounded-lg hover:bg-[#0855b1] transition-colors text-sm font-medium shadow-sm">
        ...
        <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden border border-gray-200">
            <div class="p-6">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <a href="<?php echo e(route('admin.sections.testimonials.index')); ?>" class="inline-flex items-center px-4 py-2 bg-[#003e87] text-white rounded-lg hover:bg-[#0855b1] transition-colors text-sm font-medium shadow-sm">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\temp-laravel\AnimalerieHMZ\resources\views/admin/sections/index.blade.php ENDPATH**/ ?>