        ...
        <div class="overflow-x-auto">
                        ...
                        <td colspan="5" class="block p-0">
                            <div class="p-4 border-b border-gray-100 last:border-b-0 space-y-3">
                                <div class="flex items-center gap-3">
                                    <?php if($item->product_image): ?>
                                        <?php if(filter_var($item->product_image, FILTER_VALIDATE_URL)): ?>
                                            <img src="<?php echo e($item->product_image); ?>" class="w-16 h-16 object-cover rounded-lg" alt="<?php echo e($item->product_name); ?>">
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('storage/' . $item->product_image)); ?>" class="w-16 h-16 object-cover rounded-lg" alt="<?php echo e($item->product_name); ?>">
                                        <?php endif; ?>
                                    <?php else: ?>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="font-semibold text-gray-900 text-sm truncate"><?php echo e($item->product_name); ?></p>
                                        <?php if($item->product_sku): ?>
                                        ...
                                        <div class="mt-1">
                                            <?php if($item->product): ?>
                                                ...
                                                ?>
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xxs font-medium <?php echo e($stockClass); ?>">
                                ...
                                <div class="grid grid-cols-3 gap-2 pt-2 text-xs border-t border-gray-50 text-gray-600">
                                    <div>
                                        ...
                                        <span class="font-medium text-gray-900"><?php echo e(number_format($item->price, 2)); ?> DH</span>
                                    </div>
                                    <div class="text-center">
                                        <span class="block text-gray-400 text-xxs uppercase">Quantité</span>
                                        <span class="font-bold text-gray-900">x<?php echo e($item->quantity); ?></span>
                                    </div>
                                    <div class="text-right">
                                        <span class="block text-gray-400 text-xxs uppercase">Sous-total</span>
                                        <span class="font-bold text-[#003e87]"><?php echo e(number_format($item->price * $item->quantity, 2)); ?> DH</span>
                                    </div>
                                </div>
                            </div>
                        </td>
            ...
            <div class="block md:hidden bg-gray-50 p-4 border-t border-gray-100 space-y-2">
                <div class="flex justify-between text-sm text-gray-600">
                    ...
                    <span class="font-medium text-gray-900"><?php echo e(number_format($order->subtotal, 2)); ?> DH</span>
                </div>
                <?php if($order->discount > 0): ?>
                <div class="flex justify-between text-sm text-red-600">
                    <span>Réduction</span>
                    <span class="font-medium">-<?php echo e(number_format($order->discount, 2)); ?> DH</span>
                </div>
                <?php endif; ?>
                <div class="flex justify-between text-base font-bold text-gray-900 pt-2 border-t border-gray-200">
                    <span>Total</span>
                    <span class="text-[#003e87] font-extrabold"><?php echo e(number_format($order->total, 2)); ?> DH</span>
                </div>
            </div>
        </div>
    </div>
