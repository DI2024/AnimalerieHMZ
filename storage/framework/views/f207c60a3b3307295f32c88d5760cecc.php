    ...
    <div class="flex-1 min-w-0 space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-4 sticky top-0 z-30">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-3 mb-3">
                <form id="search-form" method="GET" action="<?php echo e(route('admin.products.index')); ?>" class="flex items-center gap-3 flex-1">
                    <!-- Large Search Input -->
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\animx\AnimalerieHMZ\resources\views/admin/products/index.blade.php ENDPATH**/ ?>