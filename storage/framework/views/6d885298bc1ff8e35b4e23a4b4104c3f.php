                            ...
                            <td class="px-3 md:px-6 py-4">
                                <?php if($offer->image): ?>
                                    <?php if(filter_var($offer->image, FILTER_VALIDATE_URL)): ?>
                                        <img src="<?php echo e($offer->image); ?>" class="w-12 h-12 md:w-16 md:h-16 rounded-lg object-cover" alt="<?php echo e($offer->title); ?>">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('storage/' . $offer->image)); ?>" class="w-12 h-12 md:w-16 md:h-16 rounded-lg object-cover" alt="<?php echo e($offer->title); ?>">
                                    <?php endif; ?>
                                <?php else: ?>
                            ...
                            <td class="px-3 md:px-6 py-4">
                                <div>
                                    <div class="flex flex-wrap items-center gap-1.5 md:gap-2">
                                        <p class="font-semibold text-gray-900 text-sm md:text-base break-words"><?php echo e($offer->title); ?></p>
                                    ...
                                    <?php if($offer->subtitle): ?>
                                        <p class="text-xs md:text-sm text-gray-500 mt-1 hidden md:block break-words"><?php echo e($offer->subtitle); ?></p>
                                    <?php endif; ?>
                                </div>
                            </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\animx\AnimalerieHMZ\resources\views/admin/offers/index.blade.php ENDPATH**/ ?>