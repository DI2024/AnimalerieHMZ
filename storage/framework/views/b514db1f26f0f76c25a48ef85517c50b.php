...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="<?php echo e(old('title', $slide->title)); ?>" maxlength="255" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#003e87] focus:border-transparent" placeholder="Enter slide title">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" id="subtitle" name="subtitle" value="<?php echo e(old('subtitle', $slide->subtitle)); ?>" maxlength="255" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#003e87] focus:border-transparent" placeholder="Enter slide subtitle">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" id="button_text" name="button_text" value="<?php echo e(old('button_text', $slide->button_text)); ?>" maxlength="100" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#003e87] focus:border-transparent" placeholder="e.g., Shop Now">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" id="button_link" name="button_link" value="<?php echo e(old('button_link', $slide->button_link)); ?>" maxlength="255" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#003e87] focus:border-transparent" placeholder="e.g., /products">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" id="order" name="order" value="<?php echo e(old('order', $slide->order)); ?>" min="0" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#003e87] focus:border-transparent" placeholder="0">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\animx\AnimalerieHMZ\resources\views/admin/sections/hero/edit.blade.php ENDPATH**/ ?>