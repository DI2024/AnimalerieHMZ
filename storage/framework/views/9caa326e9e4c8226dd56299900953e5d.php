    ...
    <div class="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div class="lg:col-span-6 flex flex-col gap-8">
            ...
            <div class="flex items-center gap-6">
                <div class="space-y-1">
                    <span class="text-4xl font-black text-primary"><?php echo e(number_format($product->price, 2, ',', ' ')); ?> MAD</span>
                    <?php if($product->old_price && $product->old_price > $product->price): ?>
                        <div class="flex items-center gap-2">
                            <span class="text-lg text-on-surface-variant/50 line-through"><?php echo e(number_format($product->old_price, 2, ',', ' ')); ?> MAD</span>
