    ...
    <div class="max-w-[1280px] mx-auto px-6 py-6">
        <nav class="flex text-sm font-medium text-on-surface-variant/60">
            <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php else: ?>
                    <span class="text-on-surface"><?php echo e($breadcrumb['name']); ?></span>
                <?php endif; ?>
    ...
    <div class="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div class="lg:col-span-6 flex flex-col gap-8">
                ...
                <?php if($product->rating): ?>
                    <div class="flex items-center gap-2">
                        <div class="flex text-yellow-400">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' <?php echo e($i <= $product->rating ? 1 : 0); ?>;">star</span>
                            <?php endfor; ?>
                        </div>
                        <span class="text-sm text-on-surface-variant">(<?php echo e($product->rating); ?>/5)</span>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="flex items-center gap-6">
                <div class="space-y-1">
                    <span class="text-4xl font-black text-primary"><?php echo e(number_format($product->price, 2, ',', ' ')); ?>€</span>
                    <?php if($product->old_price && $product->old_price > $product->price): ?>
                        <div class="flex items-center gap-2">
                            <span class="text-lg text-on-surface-variant/50 line-through"><?php echo e(number_format($product->old_price, 2, ',', ' ')); ?>€</span>
                    ...
                    <div class="group relative bg-white rounded-[2rem] p-4 shadow-md hover:shadow-2xl transition duration-500 border border-gray-200">
                        <a href="<?php echo e(route('products.show', $related->slug)); ?>">
                            ...
                            <div class="flex justify-between items-center px-2">
                                <span class="text-xl font-black text-primary"><?php echo e(number_format($related->price, 2, ',', ' ')); ?>€</span>
