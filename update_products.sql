...
-- =====================================================
-- CATÉGORIE: CHIENS (category_id = 1)
-- =====================================================
...
-- =====================================================
-- CATÉGORIE: OISEAUX (category_id = 3)
-- =====================================================

-- Cages & Volières
(29, 3, 7, 'Cage d\'Élevage Zolux Primo', 'cage-elevage-zolux-primo', 'Cage d\'élevage spacieuse Zolux Primo. Idéale pour petits oiseaux.', 'Cage élevage Zolux', 54.99, 64.99, 22, 'OISEAU-CAGE-001', 'images/products/img_product_oiseau/Cage-delevage-Zolux-Primo-cati-671-300x300 (1).jpg', 1, 0, 1, 1, 15, 4.7, 86, NOW(), NOW()),

(30, 3, 7, 'Volière Design Moderne', 'voliere-design-moderne', 'Volière spacieuse au design moderne. Parfaite pour plusieurs oiseaux.', 'Volière spacieuse', 129.99, 149.99, 14, 'OISEAU-CAGE-002', 'images/products/img_product_oiseau/VL422174-e1737985565383-700x779.webp', 1, 1, 1, 1, 13, 4.8, 124, NOW(), NOW()),

-- Graines & Nutrition
(31, 3, 8, 'Mélange pour Calopsitte', 'melange-calopsitte', 'Mélange de graines spécialement formulé pour calopsittes. Nutrition complète.', 'Graines calopsitte', 12.99, 15.99, 58, 'OISEAU-GRAIN-001', 'images/products/img_product_oiseau/Melange-pour-calopsitte-e1714228585714-510x510-1.webp', 1, 0, 1, 0, 19, 4.6, 73, NOW(), NOW()),

(32, 3, 8, 'Mélange pour Canaries avec Alpiste', 'melange-canaries-alpiste', 'Mélange premium pour canaries enrichi en alpiste. Favorise le chant.', 'Graines canaries', 9.99, 12.99, 67, 'OISEAU-GRAIN-002', 'images/products/img_product_oiseau/Melange-pour-canaries-avec-alpiste-e1714147138859-510x510-1.webp', 1, 0, 1, 0, 23, 4.7, 91, NOW(), NOW()),

(33, 3, 8, 'Aliment pour Perroquet', 'aliment-perroquet', 'Aliment complet pour perroquets. Riche en vitamines et minéraux.', 'Nutrition perroquet', 18.99, 22.99, 42, 'OISEAU-GRAIN-003', 'images/products/img_product_oiseau/Aliment-pour-perroquet-510x510-1.webp', 1, 1, 0, 1, 17, 4.8, 108, NOW(), NOW()),

(34, 3, 8, 'Graines Premium Mix', 'graines-premium-mix-oiseaux', 'Mélange premium de graines variées. Pour tous types d\'oiseaux.', 'Mix premium', 14.99, NULL, 51, 'OISEAU-GRAIN-004', 'images/products/img_product_oiseau/575434__53870-700x700.webp', 1, 0, 0, 0, 0, 4.5, 64, NOW(), NOW()),

-- Accessoires
(35, 3, 9, 'Abreuvoir pour Oiseaux', 'abreuvoir-oiseaux', 'Abreuvoir automatique pour oiseaux. Facile à installer et nettoyer.', 'Abreuvoir automatique', 8.99, 11.99, 74, 'OISEAU-ACC-001', 'images/products/img_product_oiseau/Abreuvoir-oiseaux-510x510-1.webp', 1, 0, 0, 0, 25, 4.4, 56, NOW(), NOW()),

(36, 3, 9, 'HidraPlus 1kg Avianvet', 'hidraplus-1kg-avianvet', 'Complément d\'électrolytes HidraPlus. À dissoudre dans l\'eau pour une hydratation optimale.', 'Électrolytes', 18.25, NULL, 33, 'OISEAU-ACC-002', 'images/products/img_product_oiseau/hidraplus-1kg-avianvet-1825-eur-26251-avianvet-hidraplus-avianvet-est-un-complement-a-base-delectrolytes-a-dissoudre-dans-leau-o.jpg', 1, 1, 0, 0, 0, 4.7, 47, NOW(), NOW()),

(37, 3, 9, 'Perchoir Naturel', 'perchoir-naturel-oiseaux', 'Perchoir en bois naturel. Favorise le bien-être et l\'exercice des pattes.', 'Perchoir bois', 6.99, 8.99, 82, 'OISEAU-ACC-003', 'images/products/img_product_oiseau/045671b0f8370fb4e7f6f50230430e5285a325d2_33b04a0f1aa325976f5c117aee20eb1053e3f3de.webp', 1, 0, 0, 0, 22, 4.3, 38, NOW(), NOW());


-- =====================================================
-- CATÉGORIE: POISSONS (category_id = 4)
-- =====================================================

-- Aquariums
(38, 4, 10, 'EHEIM Vivaline LED 126L', 'eheim-vivaline-led-126l', 'Aquarium complet EHEIM Vivaline 126L avec éclairage LED. Design moderne et élégant.', 'Aquarium LED 126L', 189.99, 229.99, 12, 'POISSON-AQU-001', 'images/products/img_product_poisson/EHEIM-vivalineLED-126--300x300.jpg', 1, 1, 1, 1, 17, 4.8, 134, NOW(), NOW()),

(39, 4, 10, 'Aquarium Débutant Complet', 'aquarium-debutant-complet', 'Kit aquarium complet pour débutants. Tout le nécessaire pour démarrer.', 'Kit débutant', 79.99, 99.99, 24, 'POISSON-AQU-002', 'images/products/img_product_poisson/401438-300x300.jpg', 1, 0, 1, 0, 20, 4.6, 87, NOW(), NOW()),

(40, 4, 10, 'Nano Aquarium Design', 'nano-aquarium-design', 'Nano aquarium au design épuré. Parfait pour petits espaces.', 'Nano aquarium', 54.99, 64.99, 31, 'POISSON-AQU-003', 'images/products/img_product_poisson/789e13160e60e4f591114fc3149abb7e5259aac8_9f6d373777204c04c4b83b37e56d1eabc5aa59d1.webp', 1, 1, 0, 1, 15, 4.7, 96, NOW(), NOW()),

-- Nourriture poissons
(41, 4, 11, 'Basic Tropical Flakes Dajana', 'basic-tropical-flakes-dajana', 'Flocons tropicaux Dajana. Alimentation complète pour poissons tropicaux.', 'Flocons tropicaux', 8.99, 10.99, 68, 'POISSON-NOUR-001', 'images/products/img_product_poisson/basic-tropical-flakes-dajana1-300x300.jpg', 1, 0, 1, 0, 18, 4.5, 72, NOW(), NOW()),

(42, 4, 11, 'Sera KOI Royal 5.65kg', 'sera-koi-royal-565kg', 'Nourriture premium Sera pour Koï. Formule enrichie pour couleurs éclatantes.', 'Nourriture Koï premium', 42.99, 49.99, 19, 'POISSON-NOUR-002', 'images/products/img_product_poisson/sera-KOI-ROYAL-5-65-300x300.jpg', 1, 1, 1, 1, 14, 4.9, 143, NOW(), NOW()),

(43, 4, 11, 'Granulés Poissons Tropicaux', 'granules-poissons-tropicaux', 'Granulés nutritifs pour poissons tropicaux. Haute digestibilité.', 'Granulés tropicaux', 12.99, NULL, 54, 'POISSON-NOUR-003', 'images/products/img_product_poisson/178538_PHO_PRO_CLIP_8853-1.jpg', 1, 0, 0, 0, 0, 4.6, 58, NOW(), NOW()),

-- Accessoires aquarium
(44, 4, 12, 'Éponge de Filtration Trixie', 'eponge-filtration-trixie', 'Éponge de filtration pour aquarium Trixie. Filtration biologique efficace.', 'Éponge filtre', 6.99, 8.99, 89, 'POISSON-ACC-001', 'images/products/img_product_poisson/EPONGE-POUR-AQUARIUM-trixie-300x300.jpg', 1, 0, 0, 0, 22, 4.4, 45, NOW(), NOW()),

(45, 4, 12, 'Perles de Verre Lapis Lazuli', 'perles-verre-lapis-lazuli', 'Perles décoratives en verre Lapis Lazuli. Embellissent votre aquarium.', 'Décoration verre', 9.99, 12.99, 62, 'POISSON-ACC-002', 'images/products/img_product_poisson/Perles-de-Verre-Lapi-Lazuli--300x300.jpg', 1, 1, 0, 0, 23, 4.5, 51, NOW(), NOW()),

(46, 4, 12, 'Kit d\'Élevage Zolux', 'kit-elevage-zolux-poisson', 'Kit d\'élevage complet pour alevins. Sécurise et protège les jeunes poissons.', 'Kit élevage', 24.99, 29.99, 37, 'POISSON-ACC-003', 'images/products/img_product_poisson/Cage-delevage-Zolux-Primo-cati-671-300x300.jpg', 1, 0, 0, 0, 17, 4.6, 42, NOW(), NOW());


-- =====================================================
-- CATÉGORIE: PIGEONS (category_id = 5)
-- =====================================================

-- Cages & Volières
(47, 5, 13, 'Panier d\'Entraînement Aluminium Mira 110x28x61cm', 'panier-entrainement-aluminium-mira', 'Panier d\'entraînement en aluminium Demster Mira. Dimensions 110x28x61cm, léger et résistant.', 'Panier alu Mira', 89.99, 109.99, 15, 'PIGEON-CAGE-001', 'images/products/img_product_peigon/panier-d-entrainement-en-aluminium-mira-110x28x61-cm-demster.jpg', 1, 1, 1, 1, 18, 4.8, 67, NOW(), NOW()),

(48, 5, 13, 'Panier d\'Entraînement Bois Limoges 89.90x26x46cm', 'panier-entrainement-bois-limoges', 'Panier d\'entraînement en bois Demster Limoges. Dimensions 89.90x26x46cm, traditionnel et robuste.', 'Panier bois Limoges', 74.99, 89.99, 18, 'PIGEON-CAGE-002', 'images/products/img_product_peigon/panier-d-entrainement-pour-pigeon-en-bois-limoges-89-90x26x46cm-demster.jpg', 1, 0, 1, 0, 17, 4.7, 54, NOW(), NOW()),

(49, 5, 13, 'Panier d\'Exposition Petit Natural', 'panier-exposition-petit-natural', 'Panier d\'exposition petit modèle en matériaux naturels. Idéal pour concours.', 'Panier exposition', 34.99, 42.99, 26, 'PIGEON-CAGE-003', 'images/products/img_product_peigon/panier-d-exposition-petit-natural-2.jpg', 1, 0, 0, 0, 19, 4.5, 38, NOW(), NOW()),

(50, 5, 13, 'Mangeoire Pigeons Qubus 80cm Demster', 'mangeoire-pigeons-qubus-80cm', 'Mangeoire Qubus 80cm Demster. Design pratique pour alimentation collective.', 'Mangeoire Qubus 80cm', 44.99, 54.99, 22, 'PIGEON-CAGE-004', 'images/products/img_product_peigon/mangeoire-pigeons-qubus-80-cm-demster.jpg', 1, 1, 0, 1, 18, 4.6, 49, NOW(), NOW()),

-- Graines & Nutrition
(51, 5, 14, 'Mélanges Premium Pigeons', 'melanges-premium-pigeons', 'Mélanges de graines premium pour pigeons. Sélection de qualité supérieure.', 'Graines premium', 28.99, 34.99, 45, 'PIGEON-GRAIN-001', 'images/products/img_product_peigon/melanges-premium.jpg', 1, 0, 1, 1, 17, 4.7, 89, NOW(), NOW()),

(52, 5, 14, 'Enzymix 7-50 MS Mue Méthionine 20kg Beyers', 'enzymix-7-50-ms-mue-methionine-20kg', 'Enzymix 7-50 MS Beyers 20kg. Mélange de mue haute qualité enrichi en méthionine.', 'Mélange mue 20kg', 22.70, NULL, 34, 'PIGEON-GRAIN-002', 'images/products/img_product_peigon/enzymix-7-50-ms-mue-methionine-20kg-beyers-2270-eur-070050-beyers-enzymix-7-50-ms-mue-methionine-20-kg-melange-de-mue-haute-qual.jpg', 1, 1, 1, 0, 0, 4.8, 112, NOW(), NOW()),

(53, 5, 14, 'Colombine Vita 4kg Versele Laga', 'colombine-vita-4kg-versele-laga', 'Colombine Vita 4kg Versele Laga. Vitamines, oligo-éléments et minéraux en poudre.', 'Vitamines 4kg', 15.60, 18.99, 52, 'PIGEON-GRAIN-003', 'images/products/img_product_peigon/colombine-vita-4kg-vitamines-oligo-elements-et-mineraux-en-poudre-1560-eur-412361-versele-laga-vitamines-oligoelements-et-minera.jpg', 1, 0, 0, 0, 18, 4.6, 73, NOW(), NOW()),

-- Accessoires
(54, 5, 15, 'Abreuvoir-Mangeoire 8L Bleu Gaun', 'abreuvoir-mangeoire-8l-bleu-gaun', 'Abreuvoir-mangeoire 8 litres bleu Gaun. Double fonction pratique.', 'Abreuvoir 8L', 12.95, 15.99, 38, 'PIGEON-ACC-001', 'images/products/img_product_peigon/abreuvoir-mangeoire-pour-pigeons-8-l-bleu-gaun-1295-eur-30102-gaun-abreuvoir-mangeoire-pour-pigeons-8-l-bleu-gaun.jpg', 1, 0, 0, 0, 19, 4.5, 56, NOW(), NOW()),

(55, 5, 15, 'Bagues Élastiques E-Z 50 pièces 8mm Jaune', 'bagues-elastiques-ez-50-pieces-8mm', 'Bagues élastiques E-Z par 50 pièces, taille 8mm couleur jaune. Nouvelle conception 4 wings.', 'Bagues 8mm x50', 6.50, 8.99, 67, 'PIGEON-ACC-002', 'images/products/img_product_peigon/bagues-elastiques-e-z-par-50-pieces-taille-8-mm-couleur-jaune-650-eur-880err08-yellow-rings-4-wings-voila-une-nouvelle-conceptio.jpg', 1, 1, 0, 0, 28, 4.4, 42, NOW(), NOW()),

(56, 5, 15, 'Grattoir 16cm Manche Vert Plastique', 'grattoir-16cm-manche-vert', 'Grattoir 16cm manche vert en plastique Ornibird. Permet de nettoyer facilement les cages.', 'Grattoir 16cm', 4.75, 6.99, 84, 'PIGEON-ACC-003', 'images/products/img_product_peigon/grattoir-16cm-manche-vert-en-plastique-475-eur-26028-private-label-ornibird-grattoir-16cm-manche-vert-en-plastique-permet-de-net.jpg', 1, 0, 0, 0, 32, 4.3, 31, NOW(), NOW()),

(57, 5, 15, 'BactAir Spray', 'bactair-spray', 'BactAir Spray désinfectant pour colombier. Assainit l\'environnement des pigeons.', 'Spray désinfectant', 14.99, 17.99, 46, 'PIGEON-ACC-004', 'images/products/img_product_peigon/bactair-spray.jpg', 1, 0, 1, 0, 17, 4.6, 64, NOW(), NOW()),

(58, 5, 15, 'BetaChol 1L', 'betachol-1l', 'BetaChol 1 litre. Complément alimentaire pour la santé hépatique des pigeons.', 'Complément 1L', 24.99, 29.99, 29, 'PIGEON-ACC-005', 'images/products/img_product_peigon/betachol-1l.jpg', 1, 1, 0, 1, 17, 4.7, 58, NOW(), NOW()),

(59, 5, 15, 'TaubenFit E-50 Vit E Konzentrat 100ml Rohnfried', 'taubenfit-e50-vit-e-konzentrat-100ml', 'TaubenFit E-50 Rohnfried 100ml. Vitamine E et sélénium pour période d\'élevage et de vol.', 'Vitamine E 100ml', 18.99, NULL, 41, 'PIGEON-ACC-006', 'images/products/img_product_peigon/taubenfit-e-50-vit-e-konzentrat-vit-e-et-selenium-la-periode-d-elevage-et-de-vol-100ml-rohnfried.jpg', 1, 0, 0, 0, 0, 4.8, 76, NOW(), NOW());
