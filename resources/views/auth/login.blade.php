...
<body class="font-body text-on-surface bg-surface antialiased overflow-hidden transition-colors duration-300" id="bodyRoot">
    <div class="h-screen flex flex-col lg:flex-row overflow-hidden">
            ...
            <div class="relative z-10 w-full max-w-lg">
                ...
                <div class="mt-8 space-y-4">
                    <h1 class="font-headline text-3xl lg:text-4xl font-extrabold text-white leading-tight">
                        Le meilleur pour vos <span class="text-tertiary">compagnons</span>.
                    </h1>
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 sm:p-12 bg-white dark:bg-gray-900 relative h-full transition-colors duration-300 overflow-hidden py-6" id="loginSide">
            <!-- Back to Home Button -->
            ...
            <div class="w-full max-w-md space-y-8 animate-[fadeIn_0.5s_ease-out] relative z-10">
                <!-- Header -->
                <div class="text-center lg:text-left space-y-2 mb-6">
                    <img src="{{ asset('images/logo animalerie.png') }}" alt="Logo" class="h-9 w-auto mx-auto lg:mx-0 mb-4">
                    <h2 class="font-headline text-3xl font-extrabold tracking-tight text-on-surface dark:text-white">Connexion</h2>
                    <p class="text-on-surface-variant dark:text-gray-400 text-base">Heureux de vous revoir !</p>
                </div>
                ...
                <div class="ticket-card">
                    <div class="ticket-inner dark:bg-gray-800/50">
                        <form action="#" class="space-y-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center gap-5 bg-white dark:bg-gray-900 border-2 border-black dark:border-gray-600 rounded-[2rem] px-8 transition-all duration-300 focus-within:ring-8 focus-within:ring-primary/5 dark:focus-within:ring-primary/10">
                                    ...
                                    <input type="email" id="email" name="email" required placeholder="votre@email.com" 
                                        class="w-full py-5 bg-transparent border-none outline-none text-on-surface dark:text-white placeholder:text-outline/60 text-lg font-medium">
                                </div>
                            </div>
                            ...
                            <!-- Login Button -->
                            <div class="pt-4">
                                <button type="submit" class="w-full bg-primary hover:bg-primary-container text-white font-bold py-4 rounded-[2rem] shadow-xl shadow-primary/20 hover:shadow-primary/30 transform hover:-translate-y-1 active:translate-y-0 transition-all duration-300 flex items-center justify-center gap-3 text-lg group">
                                    Se connecter
                ...
                <!-- Footer -->
                <p class="text-center text-on-surface-variant dark:text-gray-400 text-base mt-8">
                    Nouveau ici ? 
