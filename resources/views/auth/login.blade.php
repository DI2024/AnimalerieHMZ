...
<head>
    ...
    <title>Connexion - Animalerie HMZ</title>
...
<body class="font-body text-on-surface bg-surface antialiased overflow-x-hidden transition-colors duration-300" id="bodyRoot">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative bg-primary overflow-hidden items-center justify-center p-12">
            ...
            <div class="relative z-10 w-full max-w-lg">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute -top-6 -right-6 glass p-4 rounded-2xl shadow-xl animate-float flex items-center justify-center min-w-[140px]">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
                                <span class="material-symbols-outlined text-[20px] leading-none">verified</span>
                            </div>
                            <div class="flex flex-col">
                                <span class="text-[10px] uppercase tracking-wider font-bold text-primary/60 leading-tight">Qualité</span>
                                <span class="font-bold text-sm leading-tight">Premium Care</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="absolute -bottom-6 -left-6 glass p-4 rounded-2xl shadow-xl animate-float-slow flex items-center justify-center min-w-[140px]">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                <span class="text-[10px] uppercase tracking-wider font-bold text-secondary/60 leading-tight">Confiance</span>
                                <span class="font-bold text-sm leading-tight">10k+ Clients</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-16 space-y-6">
                    <h1 class="font-headline text-4xl lg:text-5xl font-extrabold text-white leading-tight">
                        Offrez-leur le <span class="text-tertiary">meilleur</span>, tout simplement.
                    </h1>
                    <p class="text-white/70 text-lg max-w-md">
                        Rejoignez notre communauté de passionnés et profitez d'avantages exclusifs pour vos compagnons.
                    </p>
            ...
            <div class="absolute bottom-10 right-10 opacity-10">
                <span class="material-symbols-outlined text-[120px] text-white -rotate-12">flutter</span>
            </div>
        </div>

        <!-- Right Side: Login Form -->
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 sm:p-16 bg-white dark:bg-gray-900 relative min-h-screen transition-colors duration-300" id="loginSide">
            <!-- Back to Home Button -->
            ...
            <div class="absolute top-6 right-6 lg:top-10 lg:right-10 z-30">
                <button id="darkToggleLogin" class="w-11 h-11 flex items-center justify-center rounded-full bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition text-on-surface-variant hover:text-primary" aria-label="Basculer le mode sombre">
                    <span class="material-symbols-outlined text-[22px] leading-none" id="darkIconLogin">dark_mode</span>
                </button>
            </div>

            <div class="w-full max-w-md space-y-16 animate-[fadeIn_0.5s_ease-out] relative z-10 py-20">
                <!-- Header -->
                <div class="text-center lg:text-left space-y-6 mb-8">
                    <img src="{{ asset('images/logo animalerie.png') }}" alt="Logo" class="h-12 w-auto mx-auto lg:mx-0 mb-8">
                    <h2 class="font-headline text-4xl font-extrabold tracking-tight text-on-surface dark:text-white">Connexion</h2>
                    <p class="text-on-surface-variant dark:text-gray-400 text-lg">Heureux de vous revoir parmi nous !</p>
                </div>

                <!-- Form Card — Grand Ticket Style -->
                    ...
                    <div class="ticket-inner dark:bg-gray-800/50">
                        <form action="#" class="space-y-10">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center gap-5 bg-white dark:bg-gray-900 border-2 border-black dark:border-gray-600 rounded-[2rem] px-8 transition-all duration-300 focus-within:ring-8 focus-within:ring-primary/5 dark:focus-within:ring-primary/10">
                                    ...
                                    <input type="email" id="email" name="email" required placeholder="votre@email.com" 
                                        class="w-full py-7 bg-transparent border-none outline-none text-on-surface dark:text-white placeholder:text-outline/60 text-lg font-medium">
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center px-3">
                                    <label for="password" class="text-sm font-bold text-on-surface dark:text-gray-200">Mot de passe</label>
                                ...
                                <div class="flex items-center gap-5 bg-white dark:bg-gray-900 border-2 border-black dark:border-gray-600 rounded-[2rem] px-8 transition-all duration-300 focus-within:ring-8 focus-within:ring-primary/5">
                                    ...
                                    <button type="button" class="text-black dark:text-gray-400 hover:text-primary transition shrink-0" id="togglePassword">
                            ...
                            <div class="flex items-center justify-between py-4">
                                <label class="flex items-center gap-4 cursor-pointer group w-fit">
                                    <div class="relative flex items-center">
                                        ...
                                        <div class="w-7 h-7 border-2 border-black dark:border-gray-500 rounded-xl peer-checked:bg-black dark:peer-checked:bg-primary dark:peer-checked:border-primary peer-checked:border-black transition"></div>
                                    ...
                                    <span class="text-base font-bold text-on-surface dark:text-gray-200 group-hover:text-primary transition">Rester connecté</span>
                                </label>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button class="flex items-center justify-center gap-3 py-6 border-2 border-black dark:border-gray-600 rounded-xl hover:bg-white hover:border-primary dark:hover:border-primary transition-all duration-300">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const icon = document.getElementById('darkIconLogin');
