        ...
        <div class="max-w-[1280px] mx-auto px-6">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <a href="{{ route('products.index') }}" class="nav-link text-on-surface hover:text-primary font-medium transition-all hover:scale-105">Produits</a>
                    <a href="{{ route('home') }}#contact" class="nav-link text-on-surface hover:text-primary font-medium transition-all hover:scale-105">Contact</a>
                </div>
            ...
            <div id="mobileMenu" class="hidden md:hidden pb-4 border-t border-outline-variant mt-2 pt-4">
                <div class="flex flex-col gap-2">
                    ...
                    <a href="{{ route('products.index') }}" class="px-4 py-2 text-on-surface hover:bg-surface-container-low rounded-lg transition-colors">Produits</a>
                    <a href="{{ route('home') }}#contact" class="px-4 py-2 text-on-surface hover:bg-surface-container-low rounded-lg transition-colors">Contact</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="{{ route('home') }}#contact" class="text-primary-light hover:text-white transition-colors text-sm flex items-center gap-2"><span class="material-symbols-outlined text-sm">chevron_right</span> Contact</a></li>
                    </ul>
                </div>
