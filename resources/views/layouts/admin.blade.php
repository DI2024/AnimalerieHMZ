...
<body>
    ...
    <nav class="mobile-navbar">
        <div class="mobile-navbar-content">
            ...
            <div class="logo-center">
                <img src="{{ asset('images/logo animalerie.png') }}" alt="Logo" class="h-8 w-auto object-contain">
    ...
    <main class="main-content">
        <header class="flex justify-between items-center mb-6 md:mb-10">
            <div>
                <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight whitespace-nowrap">@yield('page-title', 'Tableau de bord')</h1>
