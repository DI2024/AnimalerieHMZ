...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">✏️ Edit Hero Slide</h1>
            <p class="text-gray-600 mt-1 text-sm md:text-base">Update hero slide information.</p>
        </div>
