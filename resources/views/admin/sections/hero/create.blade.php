...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">➕ Add New Hero Slide</h1>
            <p class="text-gray-600 mt-1 text-sm md:text-base">Create a new hero slide for your homepage.</p>
        </div>
        <a href="{{ route('admin.sections.hero.index') }}" class="inline-flex items-center justify-center px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium w-full sm:w-auto">
